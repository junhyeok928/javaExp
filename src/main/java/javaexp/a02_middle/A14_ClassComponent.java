...
public class A14_ClassComponent {
	...
	public static void main(String[] args) {
		...
		System.out.println("p01의 greatView()메서드 호출:"+p05.greatView());
...
9. 매개변수가 있는 생성자는 일반적으로 필드값을 초기화 시킬 때, 주로 사용된다.		
	...
	1) 필드값을 초기화할 때, 매개변수변과 필드명이 같은 경우에 구분하기위해서..
...
10. 기능 메서드는 주로 객체의 프로세스 처리, 입력값처리, 리턴값 처리등의 기능을 수행한다.
	...
	ex) 입으로 여러 친구들와 이야기를 할 수 있다. 기억된 정보를 음성으로 메시지로 바꾸어 외부에 전달한다.
		객체도 메서드를 통해서 필드의 데이터을 프로세스를 처리하여 외부에 리턴하여 전달할 수 있다.
