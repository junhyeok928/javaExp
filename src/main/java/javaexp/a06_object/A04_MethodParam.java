...
public class A04_MethodParam {
	...
	static void paraInt2(int num01, int num02) {
		...
		System.out.println("입력된 데이터합산:" + (num01 + num02));
	}
	...
	public static void main(String[] args) {
		...
		/*
		 * # 기능메서드 매개변수처리 연습.. 1. 기능메서드는 외부에서 호출할 때, 입력되는 데이터의 타입과 갯수에 따라서 매개변수를 선언하여
		 * 활용할 수 있다. 2. 기본 형식 리턴유형 메서드명(매개변수1, 매개변수2...){ } 3. 연습예제
		 */
		paraInt(25);
		paraInt2(27, 30);
		double num01 = 5;
